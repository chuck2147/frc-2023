...
public class L3ConeCrossAuto extends SequentialCommandGroup {

    public L3ConeCrossAuto(Swerve s_Swerve, IntakeSubsystem intakeSubsystem, ElevatorSubsystem elevatorSubsystem,
