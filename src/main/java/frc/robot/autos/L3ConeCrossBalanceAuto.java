...
public class L3ConeCrossBalanceAuto extends SequentialCommandGroup {

    public L3ConeCrossBalanceAuto(Swerve s_Swerve, IntakeSubsystem intakeSubsystem, ElevatorSubsystem elevatorSubsystem,
