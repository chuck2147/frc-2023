...
public class L2ConeCrossBalanceAuto extends SequentialCommandGroup {

    public L2ConeCrossBalanceAuto(Swerve s_Swerve, IntakeSubsystem intakeSubsystem, ElevatorSubsystem elevatorSubsystem,
